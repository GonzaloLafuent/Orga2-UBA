...
*/
#define VIRT_PAGE_OFFSET(X) 0x3FF & X // Queremos los 10 bits menos significativos
#define VIRT_PAGE_TABLE(X)  0x3FF & (X >> 12) // Queremos los 10 bits del "medio". 
#define VIRT_PAGE_DIR(X)    0x3FF & (X >> 22) // Queremos los 10 bits mas significativos 
#define CR3_TO_PAGE_DIR(X)  0xFFFFF000 & X // Queremos los 20 bits mas significativos del registro cr3, es decir la page directory
#define MMU_ENTRY_PADDR(X)  0xFFFFF000 & X // Queremos los 20 bits mas significativos de una page frame o page table
...
#define TASK_STACK_BASE   0x08003000 // 0x08002000
