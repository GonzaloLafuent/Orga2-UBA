...
tss_t tss_create_user_task(paddr_t code_start) {
  ...
  //Si de esa manera iniciamos el directorio para la tarea correspondiente
  //De esta forma respetamos el mapeo establecido para las tareas
  ...
  //A REVISAR esto vino como vadr, pero no es un vaddr lo que devuelve la funcion
...
void tss_init(void) {
  // COMPLETAR 
  // generamos las entradas para la tss de init y idle
